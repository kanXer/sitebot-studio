...
export function Footer() {
  ...
  return (
    <footer className="border-t border-slate-200/80 dark:border-slate-800/80 bg-white/80 dark:bg-slate-950/80 backdrop-blur-xl text-slate-500 dark:text-slate-400 text-xs mt-auto relative z-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-28 sm:pb-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12 mb-12">
          ...
          <div className="space-y-4 md:col-span-1">
            <Link href="/" className="flex items-center gap-3 group inline-flex">
              ...
              <div>
                <span className="text-sm font-extrabold text-slate-900 dark:text-white block font-heading tracking-tight group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">
                  SiteBot Studio
                </span>
            ...
            <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-800/80 text-[11px] font-semibold text-emerald-700 dark:text-emerald-300">
          ...
          <div>
            ...
            <ul className="space-y-2.5 font-medium">
              ...
              <li>
                <Link href="/create" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors flex items-center gap-1.5">
          ...
          <div>
            ...
            <ul className="space-y-2.5 font-medium">
              ...
              <li>
                <Link href="/admin" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors flex items-center gap-1">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 text-[11px] text-slate-500 dark:text-slate-400">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Open Shadow DOM Component Isolation</span>
              </div>
              <div className="flex items-center gap-2">
                <Zap className="w-3.5 h-3.5 text-amber-500 shrink-0" />
                <span>Qdrant Cloud &amp; Hybrid Vector Memory</span>
              </div>
              <div className="flex items-center gap-2">
                <Shield className="w-3.5 h-3.5 text-emerald-500 shrink-0" />
                <span>Anti-Prompt Injection &amp; Domain Guardrails</span>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-slate-200/60 dark:border-slate-800/60 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2 text-[11px] text-slate-400 dark:text-slate-500">
            <span>&copy; {currentYear} SiteBot Studio. All rights reserved.</span>
          </div>

          <div className="flex items-center gap-6 text-[11px] font-semibold text-slate-500 dark:text-slate-400">
            <Link href="/privacy" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
              Privacy Policy
            </Link>
            <Link href="/terms" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
